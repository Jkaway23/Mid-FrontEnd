              ...
              <div className="col-md-3 widget">
                ...
                <div className="widget-body">
                  <p className="follow-me-icons">
                    <a href><i className="fa fa-twitter fa-2" /></a>
                    <a href><i className="fa fa-dribbble fa-2" /></a>
                    <a href><i className="fa fa-github fa-2" /></a>
                    <a href><i className="fa fa-facebook fa-2" /></a>
                  </p>
                </div>
              </div>
              <div className="col-md-3 widget">
